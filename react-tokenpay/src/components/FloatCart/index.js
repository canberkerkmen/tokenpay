...
class FloatCart extends Component {
  ...
  addProduct = product => {
    ...
    userService.addOrder(product.code, product.quantity);
  ...
  removeProduct = product => {
    ...
    userService.editOrder(product.code, 0);
  ...
  changeProductQuantity = changedProduct => {
    ...
    userService.editOrder(product.code, product.quantity);
      ...
      <div className={classes.join(' ')}>
        ...
        <div className="float-cart__content">
          ...
          <div className="float-cart__footer">
            <div className="sub">Ara Toplam</div>
